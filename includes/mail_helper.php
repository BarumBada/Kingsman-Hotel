...
function send_kingsman_mail($to, $subject, $body_html)
{
    ...
    $log_entry = "[" . date('Y-m-d H:i:s') . "] EMAIL TO: $to | SUBJECT: $subject | STATUS: Simulated via SMTP Helper\n";
...
function get_branded_template($title, $content)
{
    ...
    <div
        ...
        <div style="text-align: center; border-bottom: 2px solid #c5a021; padding-bottom: 20px; margin-bottom: 30px;">
            ...
            <p style="color: #d0d0d0; font-size: 10px; text-transform: uppercase; letter-spacing: 2px;">Bespoke Hospitality Group</p>
        </div>
